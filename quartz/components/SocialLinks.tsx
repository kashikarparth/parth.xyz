    ...
    return (
      <div class={`social-links ${displayClass ?? ""}`}>
        ...
        <div class="social-icons">
          ...
          {opts.x && (
            <a href={opts.x} target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
          ...
          {opts.linkedin && (
            <a href={opts.linkedin} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
